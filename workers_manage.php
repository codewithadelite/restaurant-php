...
if(isset($_GET['reid'])){
        ...
        $del = Mysqli_query($conn,"DELETE FROM `workers` WHERE `Id` = '".$id."' ");
        if($del){
...
if(isset($_POST['add'])){
    ...
    $sql = Mysqli_query($conn,"INSERT INTO `workers` (`Names`, `Gender`, `Age`, `Adress`) VALUES ('".$name."', '".$gender."', '".$age."', '".$adress."')");
    if($sql){
        echo "<script>alert('Worker inserted successfully');</script>";
    }
    else{
        echo "<script>alert('Worker not inserted');</script>";
    }
}
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="Workers_manage.php" class="selected"><i class="fa fa-users fa-fw"></i>Workers</a>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h3 class="page-header">Workers / <a href="#" class="launch-modal" data-toggle="modal" data-target="#add_worker">Add new</a></h3>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php
                                            $sql = Mysqli_query($conn,"SELECT * FROM `workers` ORDER BY `Id` DESC");
                                            $count = 1;
                                            ...
                                            echo'<td class="text-center">
                                                <a href="workers_manage.php?reid='.$row['Id'].'"><button class="btn btn-success"><i class="fa fa-trash-o"></i></button></td>';
                                            echo'</tr>';
                                            $count ++;
                                            }
                                        ?>                                      
    ...
    <!-- end wrapper -->
    <!--worker modal-->
    <div class="modal fade" id="add_worker" style="width:40%; margin:auto;">
        <div clas="modal-dialog" >
            <form method="POST" action="workers_manage.php">
                <div class="modal-content">
                    <div class="modal-header">
                        <span><b>ADD WORKER</b></span>
