        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="messages.php" class="selected"><i class="fa fa-bell fa-fw"></i>Messages</a>
                    </li>
                    <li>
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            while ($row = Mysqli_fetch_array($sql)) {
                                                ...
                                                <a href="messages.php?reid='.$row['Id'].'"><button class="btn btn-success"><i class="fa fa-trash-o"></i></button></td>';
                                                echo'</tr>';
