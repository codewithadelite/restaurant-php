...
if(isset($_POST['message'])){
	...
	if(!empty($names) && !empty($email) && !empty($message)){
		$sql= "INSERT INTO `messages` (`Names`, `Email`, `Message`) VALUES ('".$names."', '".$email."', '".$message."')";
		...
		<div class="gtco-container">
			...
			<div class="row">
				<div class="col-sm-4 col-xs-12">
					<div id="gtco-logo"><a href="index.html"><img src="images/irezon.png" style="width:80px; height:80px;"></a></div>
				</div>
			...
			<div class="row">
					...
					<form method="POST" action="contact.php">
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="text" name="names" id="name" class="form-control" placeholder="Your Names">
							</div>
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
							<li class="url"><a href="https://irezon.com">Irezon.com</a></li>
						</ul>
					</div>
